; RUN: llc -verify-machineinstrs -disable-fp-elim -enable-shrink-wrap=false < %s -mtriple=aarch64-apple-ios -disable-post-ra -aarch64-sve-postvec=false | FileCheck --check-prefix=CHECK-APPLE %s
