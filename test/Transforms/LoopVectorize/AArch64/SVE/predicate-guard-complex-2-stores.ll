...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %25 = add <n x 4 x i64> %24, %22
  %26 = icmp ult <n x 4 x i64> %25, shufflevector (<n x 4 x i64> insertelement (<n x 4 x i64> undef, i64 1024, i32 0), <n x 4 x i64> undef, <n x 4 x i32> zeroinitializer)
  %predicate.next = call <n x 4 x i1> @llvm.propff.nxv4i1(<n x 4 x i1> %predicate, <n x 4 x i1> %26)
  %27 = extractelement <n x 4 x i1> %predicate.next, i64 0
