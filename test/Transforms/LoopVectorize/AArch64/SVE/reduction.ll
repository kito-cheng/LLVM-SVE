...
; RUN:   -disable-loop-vectorization -sve-loop-vectorize -force-vector-interleave=1 -force-vector-width=4 \
...
;CHECK-LABEL: middle.block
;CHECK: call i32 @llvm.experimental.vector.reduce.and.i32.nxv4i32
;CHECK: ret i32
...
;CHECK-LABEL: middle.block
;CHECK: call i1 @llvm.experimental.vector.reduce.and.i1.nxv4i1
;CHECK: ret i1
...
;CHECK-LABEL: middle.block
;CHECK: call i32 @llvm.experimental.vector.reduce.or.i32.nxv4i32
;CHECK: ret i32
...
;CHECK-LABEL: middle.block
;CHECK: call i32 @llvm.experimental.vector.reduce.xor.i32.nxv4i32
;CHECK: ret i32
...
;CHECK-LABEL: middle.block
;CHECK: call fast float @llvm.experimental.vector.reduce.fadd.f32.f32.nxv4f32(float undef, <n x 4 x float>
;CHECK: ret float
