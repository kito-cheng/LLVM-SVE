...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %23 = add <n x 4 x i64> %22, %20
  %24 = icmp ult <n x 4 x i64> %23, shufflevector (<n x 4 x i64> insertelement (<n x 4 x i64> undef, i64 1024, i32 0), <n x 4 x i64> undef, <n x 4 x i32> zeroinitializer)
  %predicate.next = call <n x 4 x i1> @llvm.propff.nxv4i1(<n x 4 x i1> %predicate, <n x 4 x i1> %24)
  %25 = extractelement <n x 4 x i1> %predicate.next, i64 0
  br i1 %25, label %vector.body, label %for.cond.cleanup, !llvm.loop !7
