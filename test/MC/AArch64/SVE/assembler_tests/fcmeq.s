...
fcmeq   p0.h, p0/z, z0.h, #0.0  // 01100101-01010010-00100000-00000000
// CHECK: fcmeq   p0.h, p0/z, z0.h, #0.0{{0*}} // encoding: [0x00,0x20,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00100000-00000000
FCMEQ   P0.H, P0/Z, Z0.H, #0.0  // 01100101-01010010-00100000-00000000
// CHECK: fcmeq   p0.h, p0/z, z0.h, #0.0{{0*}} // encoding: [0x00,0x20,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00100000-00000000
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-11010101-01110101-01000101
fcmeq   p5.h, p5/z, z10.h, #0.0  // 01100101-01010010-00110101-01000101
// CHECK: fcmeq   p5.h, p5/z, z10.h, #0.0{{0*}} // encoding: [0x45,0x35,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00110101-01000101
FCMEQ   P5.H, P5/Z, Z10.H, #0.0  // 01100101-01010010-00110101-01000101
// CHECK: fcmeq   p5.h, p5/z, z10.h, #0.0{{0*}} // encoding: [0x45,0x35,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00110101-01000101
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-11000000-01100000-00000000
fcmeq   p7.h, p3/z, z13.h, #0.0  // 01100101-01010010-00101101-10100111
// CHECK: fcmeq   p7.h, p3/z, z13.h, #0.0{{0*}} // encoding: [0xa7,0x2d,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00101101-10100111
FCMEQ   P7.H, P3/Z, Z13.H, #0.0  // 01100101-01010010-00101101-10100111
// CHECK: fcmeq   p7.h, p3/z, z13.h, #0.0{{0*}} // encoding: [0xa7,0x2d,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00101101-10100111
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-10010010-00101101-10100111
fcmeq   p15.h, p7/z, z31.h, #0.0  // 01100101-01010010-00111111-11101111
// CHECK: fcmeq   p15.h, p7/z, z31.h, #0.0{{0*}} // encoding: [0xef,0x3f,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00111111-11101111
FCMEQ   P15.H, P7/Z, Z31.H, #0.0  // 01100101-01010010-00111111-11101111
// CHECK: fcmeq   p15.h, p7/z, z31.h, #0.0{{0*}} // encoding: [0xef,0x3f,0x52,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010010-00111111-11101111
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-10000000-01100000-00000000
fcmeq   p5.h, p5/z, z10.h, z21.h  // 01100101-01010101-01110101-01000101
// CHECK: fcmeq   p5.h, p5/z, z10.h, z21.h // encoding: [0x45,0x75,0x55,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010101-01110101-01000101
FCMEQ   P5.H, P5/Z, Z10.H, Z21.H  // 01100101-01010101-01110101-01000101
// CHECK: fcmeq   p5.h, p5/z, z10.h, z21.h // encoding: [0x45,0x75,0x55,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01010101-01110101-01000101
fcmeq   p7.h, p3/z, z13.h, z8.h  // 01100101-01001000-01101101-10100111
// CHECK: fcmeq   p7.h, p3/z, z13.h, z8.h // encoding: [0xa7,0x6d,0x48,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01001000-01101101-10100111
FCMEQ   P7.H, P3/Z, Z13.H, Z8.H  // 01100101-01001000-01101101-10100111
// CHECK: fcmeq   p7.h, p3/z, z13.h, z8.h // encoding: [0xa7,0x6d,0x48,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01001000-01101101-10100111
fcmeq   p15.h, p7/z, z31.h, z31.h  // 01100101-01011111-01111111-11101111
// CHECK: fcmeq   p15.h, p7/z, z31.h, z31.h // encoding: [0xef,0x7f,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-01111111-11101111
FCMEQ   P15.H, P7/Z, Z31.H, Z31.H  // 01100101-01011111-01111111-11101111
// CHECK: fcmeq   p15.h, p7/z, z31.h, z31.h // encoding: [0xef,0x7f,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-01111111-11101111
fcmeq   p0.h, p0/z, z0.h, z0.h  // 01100101-01000000-01100000-00000000
// CHECK: fcmeq   p0.h, p0/z, z0.h, z0.h // encoding: [0x00,0x60,0x40,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000000-01100000-00000000
FCMEQ   P0.H, P0/Z, Z0.H, Z0.H  // 01100101-01000000-01100000-00000000
// CHECK: fcmeq   p0.h, p0/z, z0.h, z0.h // encoding: [0x00,0x60,0x40,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000000-01100000-00000000
