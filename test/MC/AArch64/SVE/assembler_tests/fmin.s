...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-10011111-10000000-00000000
fmin    z21.h, p5/m, z21.h, z10.h  // 01100101-01000111-10010101-01010101
// CHECK: fmin    z21.h, p5/m, z21.h, z10.h // encoding: [0x55,0x95,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10010101-01010101
FMIN    Z21.H, P5/M, Z21.H, Z10.H  // 01100101-01000111-10010101-01010101
// CHECK: fmin    z21.h, p5/m, z21.h, z10.h // encoding: [0x55,0x95,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10010101-01010101
fmin    z0.h, p0/m, z0.h, z0.h  // 01100101-01000111-10000000-00000000
// CHECK: fmin    z0.h, p0/m, z0.h, z0.h // encoding: [0x00,0x80,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10000000-00000000
FMIN    Z0.H, P0/M, Z0.H, Z0.H  // 01100101-01000111-10000000-00000000
// CHECK: fmin    z0.h, p0/m, z0.h, z0.h // encoding: [0x00,0x80,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10000000-00000000
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-11011111-10001100-00110111
fmin    z31.h, p7/m, z31.h, #1.0  // 01100101-01011111-10011100-00111111
// CHECK: fmin    z31.h, p7/m, z31.h, #1.0{{0*}} // encoding: [0x3f,0x9c,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10011100-00111111
FMIN    Z31.H, P7/M, Z31.H, #1.0  // 01100101-01011111-10011100-00111111
// CHECK: fmin    z31.h, p7/m, z31.h, #1.0{{0*}} // encoding: [0x3f,0x9c,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10011100-00111111
fmin    z31.h, p7/m, z31.h, z31.h  // 01100101-01000111-10011111-11111111
// CHECK: fmin    z31.h, p7/m, z31.h, z31.h // encoding: [0xff,0x9f,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10011111-11111111
FMIN    Z31.H, P7/M, Z31.H, Z31.H  // 01100101-01000111-10011111-11111111
// CHECK: fmin    z31.h, p7/m, z31.h, z31.h // encoding: [0xff,0x9f,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10011111-11111111
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-11000111-10000000-00000000
fmin    z23.h, p3/m, z23.h, #1.0  // 01100101-01011111-10001100-00110111
// CHECK: fmin    z23.h, p3/m, z23.h, #1.0{{0*}} // encoding: [0x37,0x8c,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10001100-00110111
FMIN    Z23.H, P3/M, Z23.H, #1.0  // 01100101-01011111-10001100-00110111
// CHECK: fmin    z23.h, p3/m, z23.h, #1.0{{0*}} // encoding: [0x37,0x8c,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10001100-00110111
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-10011111-10011100-00111111
fmin    z23.h, p3/m, z23.h, z13.h  // 01100101-01000111-10001101-10110111
// CHECK: fmin    z23.h, p3/m, z23.h, z13.h // encoding: [0xb7,0x8d,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10001101-10110111
FMIN    Z23.H, P3/M, Z23.H, Z13.H  // 01100101-01000111-10001101-10110111
// CHECK: fmin    z23.h, p3/m, z23.h, z13.h // encoding: [0xb7,0x8d,0x47,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01000111-10001101-10110111
...
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-11011111-10000000-00000000
fmin    z0.h, p0/m, z0.h, #0.0  // 01100101-01011111-10000000-00000000
// CHECK: fmin    z0.h, p0/m, z0.h, #0.0{{0*}} // encoding: [0x00,0x80,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10000000-00000000
FMIN    Z0.H, P0/M, Z0.H, #0.0  // 01100101-01011111-10000000-00000000
// CHECK: fmin    z0.h, p0/m, z0.h, #0.0{{0*}} // encoding: [0x00,0x80,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10000000-00000000
fmin    z21.h, p5/m, z21.h, #0.0  // 01100101-01011111-10010100-00010101
// CHECK: fmin    z21.h, p5/m, z21.h, #0.0{{0*}} // encoding: [0x15,0x94,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10010100-00010101
FMIN    Z21.H, P5/M, Z21.H, #0.0  // 01100101-01011111-10010100-00010101
// CHECK: fmin    z21.h, p5/m, z21.h, #0.0{{0*}} // encoding: [0x15,0x94,0x5f,0x65]
// CHECK-ERROR: instruction requires: sve
// CHECK-ERROR-NEXT: 01100101-01011111-10010100-00010101
